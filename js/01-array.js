...
// findFriendByName(friends, 'Borys');

// console.log(findFriendByName(friends, 'Poly'));
// console.log(findFriendByName(friends, 'Chelsy'));
// console.log(findFriendByName(friends, 'Borys'));
...
// function getCommonUsersInfo(users) {
//   const res = [];
...
// console.log(getCommonUsersInfo(users));
...
// console.table(task3(users2));

//!=========================================

// function removeUsersWithBiz(arr) {
//   const res = [];
...
// console.table(removeUsersWithBiz(users2));
